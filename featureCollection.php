    ...
    <div class="col-11 mx-auto " style="background-color: #000000">
        <div class="col-12 m-auto">
            <div class="d-flex justify-content-center m-auto py-5">
                <p id="header">FEATURE COLLECTIONS</p>
            </div>
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                ...
                <div class="col cards">
                    ...
                    <div class="product-tumb">
                        <img src="adminPanel/img/<?php echo $row['product_img']; ?>" alt="" />
                    </div>
                    <div class="product-details">
                        ...
                        <div class="product-bottom-details">
                            <div class="product-price"><small>$96.00</small>$<?php echo $row["product_price"];?></div>
                    ...
                    if($i==4) {
                        ?>
                            <div class="d-flex justify-content-center m-auto py-5" id="loadMoreprodDiv">
                                <button type="button" class="btn btn-danger" style="font-weight: 500; font-size: 17px; padding: 10px 30px; letter-spacing: 3px; display: inline-block;"><a href="https://localhost/kalteeNew/jackets.php">VIEW ALL</a></button>
                            </div>
                        <?php
                        break;
                            }
