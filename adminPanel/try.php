                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="add_categories.php" class="dropdown-item">Add Categories</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="typography.php" class="dropdown-item">Show Products</a>
                            <a href="element.php" class="dropdown-item">Edit Products</a>
                        </div>
                    </div>
